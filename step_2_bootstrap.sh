...
function _record-commands-for-readme {
  ...
  TF_COMMANDS_FROM_ROOT_DIR[${ENV_NAME}, "init"]="terraform -chdir='$(_rel-path "${ENV_DIR}")' init -reconfigure"
  ...
  TF_COMMANDS_FROM_ROOT_DIR[${ENV_NAME}, "state-init"]="terraform -chdir='$(_rel-path "${TF_STATE_ENV_DIR}")' init -reconfigure -backend-config='${ENV_TF_STATE_BACKEND_VARS_FILE_NAME}'"
  ...
  TF_COMMANDS_FROM_ENV_DIR[${ENV_NAME}, "init"]="terraform init -reconfigure"
  ...
  TF_COMMANDS_FROM_ENV_DIR[${ENV_NAME}, "state-init"]="terraform init -reconfigure -backend-config='${ENV_TF_STATE_BACKEND_VARS_FILE_NAME}'"
